    ...
    return (
        <div className="md:hidden fixed bottom-10 left-0 right-0 z-[200] flex justify-center px-4 pointer-events-none">
            <motion.div
                ...
                className="relative pointer-events-auto flex items-center h-20 bg-white/30 backdrop-blur-[24px] saturate-150 rounded-[2.75rem] px-3 shadow-[0_8px_32px_rgba(255,255,255,0.2)] border border-white/40 transition-all duration-300"
            >
                {tabs.map((tab) => {
