...
const NewSaleModal = ({ isOpen, onClose, onSaleComplete, isMinimized, onMinimize, onRestore }) => {
    ...
    const handleProcessSale = async () => {
        ...
        try {
            ...
            // Use local time for the date to avoid timezone shifts
            const now = new Date();
                    ...
                    <div className="flex-1 flex flex-col lg:flex-row min-h-0 bg-gray-50/50">
                            ...
                            <div className="p-4 border-b border-gray-100 space-y-3 shrink-0">
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white border border-primary/5 rounded-3xl py-6 pl-16 pr-16 focus:ring-1 focus:ring-primary outline-none shadow-sm transition-all text-lg"
                                    />
                                    <button 
                                        onClick={() => setIsScannerOpen(true)}
                                        className="absolute right-4 top-1/2 -translate-y-1/2 p-3 bg-gold text-primary rounded-2xl hover:bg-gold-light transition-all shadow-lg shadow-gold/10 active:scale-95"
                                    >
                        ...
                        <div className={`flex-[1] lg:w-[400px] flex flex-col bg-white shrink-0 overflow-y-auto lg:overflow-visible pb-safe ${step === 2 ? 'flex' : 'hidden lg:flex'}`}>
                            ...
                            <div className="p-4 space-y-4 bg-white">
                                ...
                                <div className="pb-safe h-2 lg:hidden" />
