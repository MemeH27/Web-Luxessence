...
const InvoiceTemplate = React.forwardRef(({ saleData }, ref) => {
    ...
    return (
        <div className="flex-1 overflow-y-auto no-scrollbar">
            <div id="invoice-capture-area" ref={ref} className="bg-white p-6 md:p-14 lg:p-20 invoice-container">
                {/* Header Design */}
                <div className="flex flex-col md:flex-row justify-between gap-8 border-b-2 border-primary/10 pb-10">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1">
                            <p className="text-[10px] md:text-xs font-black text-gray-400 uppercase tracking-[0.3em]">Tienda 100% Online</p>
                    ...
                    <div className="text-left md:text-right flex flex-col justify-end space-y-4">
                        <div className="space-y-4">
                            <div>
                                <p className="text-[10px] uppercase font-black text-gray-400 tracking-widest text-[10px] uppercase font-black text-gray-400 tracking-widest whitespace-nowrap">Nº de Factura</p>
                                <p className="text-xl lg:text-2xl font-mono font-bold text-primary">#LUX-{sale.id.slice(0, 8).toUpperCase()}</p>
                            </div>
                            <div>
                                <p className="text-[10px] uppercase font-black text-gray-400 tracking-widest text-[10px] uppercase font-black text-gray-400 tracking-widest whitespace-nowrap">Fecha de Emisión</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 py-12">
                    ...
                    <div className="space-y-4 md:text-right">
                        <p className="text-[10px] uppercase font-black text-gray-400 tracking-widest md:border-r-2 md:border-primary md:pr-3 whitespace-nowrap">Detalles de Venta</p>
                ...
                <div className="space-y-4">
                    ...
                    <div className="rounded-[2rem] border border-primary/5 bg-gray-50/50 overflow-hidden shadow-sm">
                        <table className="w-full text-left">
                            <thead>
                                <tr className="bg-primary text-white text-[9px] md:text-[10px] uppercase font-black tracking-[0.2em]">
                                    <th className="px-8 py-5">Cant.</th>
                                    <th className="px-6 py-5">Descripción</th>
                                    <th className="px-6 py-5 text-right font-serif">Precio Unit.</th>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {items.map((item, idx) => (
                                    <tr key={idx} className="text-sm group hover:bg-white transition-colors">
                                        ...
                                        <td className="px-6 py-5 text-right text-gray-500 font-medium italic">L. {Number(item.price).toLocaleString()}</td>
                                        <td className="px-8 py-5 text-right font-black text-primary">L. {(item.price * item.quantity).toLocaleString()}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                            ...
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="bg-orange-100/50 text-orange-800 text-[9px] uppercase font-black tracking-[0.2em]">
                                        ...
                                        <th className="px-8 py-4 text-right">Monto Pagado</th>
                                    </tr>
                                </thead>
                ...
                <div className="mt-14 pt-10 border-t-2 border-primary/5 flex flex-col md:flex-row justify-end items-start gap-12">
                ...
                <div className="mt-14 space-y-6 border-t border-primary/5 pt-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        ...
                        {sale.payment_method === 'Crédito' && (
                            <div className="bg-orange-50/30 p-4 rounded-xl border border-orange-100/50 flex items-center gap-4 text-center md:text-left">
                                <CreditCard className="w-6 h-6 text-orange-500/50 shrink-0 hidden md:block" />
                                <div className="space-y-1">
